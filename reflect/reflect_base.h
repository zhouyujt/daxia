...
namespace daxia
{
	namespace reflect
	{
		...
		public:
			...
			virtual daxia::string ToString(const char* tag, size_t arrayElementIndex = -1) const = 0;
			virtual void FromString(const char* tag, const daxia::string& str, size_t arrayElementIndex = -1) = 0;
		public:
