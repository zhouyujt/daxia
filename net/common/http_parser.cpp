...
namespace daxia
{
	namespace net
	{
		namespace common
		{
			...
			bool HttpServerParser::Marshal(daxia::net::common::BasicSession* session, const daxia::net::common::byte* data, size_t len, daxia::net::common::shared_buffer& buffer) const
			{
				...
				{
					if (len) response->ContentLength = daxia::string::ToString(len);
				}
			...
			daxia::net::common::Parser::Result HttpServerParser::Unmarshal(daxia::net::common::BasicSession* session, const daxia::net::common::byte* data, size_t len, int& msgID, daxia::net::common::shared_buffer& buffer, size_t& packetLen) const
			{
			...
			bool HttpClientParser::Marshal(daxia::net::common::BasicSession* session, const daxia::net::common::byte* data, size_t len, daxia::net::common::shared_buffer& buffer) const
			{
				throw "尚未实现";
			}

			daxia::net::common::Parser::Result HttpClientParser::Unmarshal(daxia::net::common::BasicSession* session, const daxia::net::common::byte* data, size_t len, int& msgID, daxia::net::common::shared_buffer& buffer, size_t& packetLen) const
			{
				daxia::string header((const char*)data, MIN(len, LIMIT_START_LINE_SIZE));
